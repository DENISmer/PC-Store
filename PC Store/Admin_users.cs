...
namespace PC_Store
{
    public partial class Admin_users : Form
    {
        ...
        {
            string SQL_Grid = "SELECT * FROM Пользователи";
        ...
        private void add_Click(object sender, EventArgs e)
        {
            ...
            string insS = "INSERT Пользователи (Логин,Пароль,Заказ) values ('" + textBox2.Text
                + "','" + textBox3.Text
                + "','" + textBox4.Text
                + "')";
        ...
        private void delete_Click(object sender, EventArgs e)
        {
            ...
            {
                string sql = "DELETE FROM Пользователи WHERE [ID Пользователя] = '" + id + "'";
        ...
        private void save_Click(object sender, EventArgs e)
        {
            ...
            string change = "UPDATE Пользователи Set Логин = '"
                + textBox2.Text + "',Пароль = '" +
                textBox3.Text + "',Заказ = '" +
                textBox4.Text + "' where [ID Пользователя] = '" + textBox1.Text + "'";
